...
echo "Dependencies installation finished. You now can run 'docker-compose -f docker-compose-nodejs.yml up' and navigate your browser to http://127.0.0.1:8081 to finish installation"